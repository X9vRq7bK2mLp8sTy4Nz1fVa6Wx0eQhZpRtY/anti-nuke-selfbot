  ...
  async execute(client, role) {
    ...
    try {
      ...
      if (createEntry && createEntry.executor) {
        ...
        await db.saveCreatedRole(guild.id, role.id);
        ...
        if (thresholdExceeded) {
          ...
          const createdRoleIds = await db.getCreatedRoles(guild.id, timeWindow);
          ...
          if (AntiNukeManager.isRoleRecoveryEnabled()) {
            ...
            if (successCount > 0) await db.clearCreatedRoles(guild.id);
          }
