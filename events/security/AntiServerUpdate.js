  ...
  async execute(client, oldGuild, newGuild) {
    ...
    try {
      ...
      if (updateEntry && updateEntry.executor) {
        ...
        await db.saveOriginalServer(newGuild.id, originalMetadata);
        ...
        if (thresholdExceeded) {
          ...
          if (executorPunished) {
            ...
            const originalData = await db.getOriginalServer(newGuild.id);
            if (originalData) {
              ...
              await db.deleteOriginalServer(newGuild.id);
            }
          }
